        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    last_online_at = table.Column<DateTime>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    time_control_minutes = table.Column<int>(type: "INTEGER", nullable: false),
                    starts_at = table.Column<DateTime>(type: "TEXT", nullable: false),
                    created_at = table.Column<DateTime>(type: "TEXT", nullable: false),
                    ID_winner = table.Column<int>(type: "INTEGER", nullable: true),
                    total_rounds = table.Column<int>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID_game = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    ID_white_player = table.Column<int>(type: "INTEGER", nullable: false),
                    ID_black_player = table.Column<int>(type: "INTEGER", nullable: false),
                    ID_winner = table.Column<int>(type: "INTEGER", nullable: true),
                    result = table.Column<string>(type: "TEXT", maxLength: 20, nullable: true),
                    status = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false),
                    time_control_minutes = table.Column<int>(type: "INTEGER", nullable: false),
                    time_control_increment = table.Column<int>(type: "INTEGER", nullable: false),
                    current_fen = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    pgn = table.Column<string>(type: "TEXT", nullable: true),
                    white_time_remaining = table.Column<int>(type: "INTEGER", nullable: false),
                    black_time_remaining = table.Column<int>(type: "INTEGER", nullable: false),
                    started_at = table.Column<DateTime>(type: "TEXT", nullable: true),
                    last_move_at = table.Column<DateTime>(type: "TEXT", nullable: true),
                    ended_at = table.Column<DateTime>(type: "TEXT", nullable: true),
                    created_at = table.Column<DateTime>(type: "TEXT", nullable: false),
                    ID_tournament = table.Column<int>(type: "INTEGER", nullable: true),
                    tournament_round = table.Column<int>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    seed_number = table.Column<int>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID_move = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    ID_game = table.Column<int>(type: "INTEGER", nullable: false),
                    move_number = table.Column<int>(type: "INTEGER", nullable: false),
                    player_color = table.Column<string>(type: "TEXT", maxLength: 1, nullable: false),
                    move_notation = table.Column<string>(type: "TEXT", maxLength: 10, nullable: false),
                    fen_after_move = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    made_at = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID_history = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    ID_user = table.Column<int>(type: "INTEGER", nullable: false),
                    ID_game = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ID_player1 = table.Column<int>(type: "INTEGER", nullable: true),
                    ID_player2 = table.Column<int>(type: "INTEGER", nullable: true),
                    ID_winner = table.Column<int>(type: "INTEGER", nullable: true),
                    ID_next_match = table.Column<int>(type: "INTEGER", nullable: true),
                    is_final = table.Column<bool>(type: "INTEGER", nullable: false),
                    scheduled_at = table.Column<DateTime>(type: "TEXT", nullable: true),
                    status = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false)
                },
                constraints: table =>
                {
